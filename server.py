...
访问 http://127.0.0.1:8010/chemical/new?moduleId=9
"""
import mimetypes
import os
import sys
...
def nbpx():
    ...
    if RECORD:
        try:
            ...
            hdrs.setdefault("Referer", ORIGIN + "/chemical/new")
...
if __name__ == "__main__":
    ...
    print(f"NB offline lab  ->  http://127.0.0.1:{PORT}/chemical/new?moduleId=9")
